...
/**
 * Represents a class which takes two instances of the same class and expects the properties of the classes
 * to be lerped based on a given fraction. For example, say the class contains a singular integer, and the first
 * class is 0.2, while the second is 0.8. If the fraction is 0.5, then the value of this, would be 0.5.
 *
 * @author sen
 * @since 1.0
 */
